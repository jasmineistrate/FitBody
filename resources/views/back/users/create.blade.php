...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded shadow-md max-w-md w-full m-auto mt-8 mb-8 bg-gradient-to-r from-gray-200 to-purple-200">
        <div class="flex items-center">
            ...
            <h2 class="text-2xl font-semibold mb-6 mt-4 text-pink-600">Create user</h2>
        </div>
        <form action="{{route('store.users')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" placeholder="User`s name" class="mt-1 p-2 w-full border-2 rounded-md border-pink-200">
            </div>

            <!-- Email -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-600">Email</label>
                <input type="email" id="email" name="email" placeholder="maria@gmail.com" class="mt-1 p-2 w-full border-2 rounded-md border-pink-200">
            </div>
