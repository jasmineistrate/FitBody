...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded shadow-md max-w-md w-full m-auto mt-8 mb-8 bg-gradient-to-r from-gray-200 to-purple-200">
        <div class="flex items-center">
            ...
            <h2 class="text-2xl font-semibold mb-6 mt-4 text-pink-600">Create trainer</h2>
        </div>
        <form action="{{route('store.trainers')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Name -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-600">Trainer's name</label>
                <input type="text" id="name" name="name" placeholder="Trainer's name" class="mt-1 p-2 w-full border-2 rounded-md border-pink-200">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="speciality" name="speciality" placeholder="Trainer's speciality" class="mt-1 p-2 w-full border-2 rounded-md border-pink-200">
            </div>

            <!-- Description -->
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-600">Description</label>
                <textarea id="description" name="description" placeholder="Write a few words about this trainer" rows="5"
